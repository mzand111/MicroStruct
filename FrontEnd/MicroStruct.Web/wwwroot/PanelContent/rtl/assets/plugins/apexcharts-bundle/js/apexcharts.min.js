...
! function (t, e) {
  ...
  var w, k, A = {
      ...
      options: {
        ...
        toolbar: {
          exportToSVG: "دانلود فرمت SVG",
          exportToPNG: "دانلود فرمت PNG",
          exportToCSV: "دانلود فرمت CSV",
          menu: "منو",
          selection: "انتخاب",
          selectionZoom: "بزرگ نمایی انتخاب",
          zoomIn: "بزرگ نمایی",
          zoomOut: "کوچک نمایی",
          pan: "متحرکت کردن",
          reset: "تنظیم مجدد زوم"
        }
      }
    },
    S = function () {
          ...
          if (d.show)
            for (var g = 0; g <= l.length - 1; g++) {
              ...
              var x = s.drawText({
                ...
                y: i + e + d.offsetY - f,
                text: u,
                textAnchor: this.yaxis.opposite ? "start" : "start",
          ...
          if (e.config.yaxis[t].labels.show)
            for (var x = function (o) {
                ...
                var b = i.drawText({
                  ...
                  text: p,
                  textAnchor: e.config.yaxis[t].opposite ? "end" : "start",
                  fontSize: s,
                  fontFamily: r,
                  fontWeight: n,
      ...
      return a(t, [{
        ...
        value: function (t) {
          var e = this.w,
            ...
            s = i.offsetY,
            r = "middle";
          if ("left" === i.align ? (a = 10, r = "start") : "right" === i.align && (a = e.globals.svgWidth - 10, r = "start"), a += i.offsetX, s = s + parseInt(i.style.fontSize, 10) + i.margin / 2, void 0 !== i.text) {
    ...
    lt = function () {
      ...
      return a(t, [{
        ...
        value: function (t, e) {
          ...
          a.style.position = "absolute", r = r + t + i.config.legend.offsetX, n = n + e + i.config.legend.offsetY, a.style.left = r + "px", a.style.top = n + "px", "bottom" === i.config.legend.position ? (a.style.top = "auto", a.style.bottom = 5 - i.config.legend.offsetY + "px") : "right" === i.config.legend.position && (a.style.right = "auto", a.style.left = 25 + i.config.legend.offsetX + "px");
      ...
      return a(t, [{
        ...
        value: function () {
          var t = this,
            ...
            a = i();
          if (a.setAttribute("class", "apexcharts-toolbar"), a.style.top = e.config.chart.toolbar.offsetY + "px", a.style.left = 3 - e.config.chart.toolbar.offsetX + "px", e.globals.dom.elWrap.appendChild(a), this.elZoom = i(), this.elZoomIn = i(), this.elZoomOut = i(), this.elPan = i(), this.elSelection = i(), this.elZoomReset = i(), this.elMenuIcon = i(), this.elMenu = i(), this.elCustomIcons = [], this.t = e.config.chart.toolbar.tools, Array.isArray(this.t.customIcons))
      ...
      return a(t, [{
        ...
        value: function (t, e) {
          var i = "middle",
            a = t.x,
            s = t.y;
          return Math.abs(t.x) >= 10 ? t.x > 0 ? (i = "end", a += 10) : t.x < 0 && (i = "start", a -= 10) : i = "middle", Math.abs(t.y) >= e - 10 && (t.y < 0 ? s -= 10 : t.y > 0 && (s += 10)), {
            textAnchor: i,
            newX: a,
            newY: s
          }
